    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-9">
            ...
            <div calss="request_type">
                <label for="request_type"><h2><?php echo($row['request_type'])?></h2></label>
              </div>
              <div calss="subject">
            ...
            <form action="update.php?id=<?php echo($row['approval_id'])?>" method="post" class="form" id="algin-form">
              <div class="row">
                <div class="add_money">
                  ...
                  <input type="integer" name="money" id="number" class="number">
                </div>
                <div class="form__field2">
                      <input type="submit" name="Aj" value="Accept">
                      <input type="submit" name="Aj" value="Review">
